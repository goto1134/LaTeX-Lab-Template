...
{\texorpdfstring{Разработка вариантов использования системы и сценариев использования системы}{Разработка вариантов использования системы и сценариев использования системы}}
\newcommand{\courseName}
{Ведение крупных программных проектов}
\newcommand{\labNumber}
{1}
