...
{\texorpdfstring{Разработка протокола взаимодействия, поддерживаемого компонентном распределенной системы}{Разработка протокола взаимодействия, поддерживаемого компонентном распределенной системы}}
