...
{\texorpdfstring{Описание поведения компонента распределённой системы с помощью детерминированных конечных автоматов}{Описание поведения компонента распределённой системы с помощью детерминированных конечных автоматов}}
